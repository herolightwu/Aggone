...
public class SubscriptionActivity extends BaseActivity {
    ...
    SubscriptionAdapter.EventListener subscriberListener = new SubscriptionAdapter.EventListener() {
        ...
        public void onClickSubscribe(final int index) {
            API.deleteFollow(SubscriptionActivity.this, users.get(index).id, new APICallback<Boolean>() {
                @Override
    ...
    OnRefreshListener refreshListener = new OnRefreshListener() {
        ...
        public void onRefresh(@NonNull final RefreshLayout refreshLayout) {
            API.getFollowing(SubscriptionActivity.this , new APICallback<List<User>>() {
                @Override
                public void onSuccess(List<User> response) {
                    ...
                    String stotal = prettyCount(nTotal) + " Subscriptions";
    ...
    void setActivity() {
        ...
        txt_total.setText(prettyCount(users.size()) + " Subscriptions");
    }
