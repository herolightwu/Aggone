...
public class LookingClubActivity extends BaseActivity {
    ...
    LookingClubAdapter.EventListener clubListener = admob -> {
        Intent intent = new Intent(LookingClubActivity.this, ProfileActivity.class);
    ...
    OnRefreshListener refreshListener = new OnRefreshListener() {
        ...
        public void onRefresh(@NonNull final RefreshLayout refreshLayout) {
            API.filterAdmobs(LookingClubActivity.this, selectedSport, edit_city.getText().toString(), edit_nation.getText().toString(), new APICallback<List<Admob>>() {
                @Override
                public void onSuccess(List<Admob> response) {
                    refreshLayout.finishRefresh();
                    admobs.clear();
                    admobs.addAll(response);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_looking_club);
    ...
    void setActivity() {
        ...
        adapter = new LookingClubAdapter(this, admobs, clubListener);
            ...
            if (resultCode == RESULT_OK) {
                ...
                if (addr.length > 1){
                    ...
                    if (addr[length - 1].trim().equals("USA"))
                        c_code = "US";
                    if (c_code != null){
                        Drawable flag = FlagKit.drawableWithFlag(LookingClubActivity.this, c_code.toLowerCase());
